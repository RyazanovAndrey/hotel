            ...
            <div className="container mx-auto px-3">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-20 items-center">
                    <div className="flex flex-col lg:flex-row gap-5">
                        <img className='rounded-xl' src="home-about.jpg" alt="" />
                        <div className="flex gap-4 lg:flex-col">
                            <img className='rounded-xl w-1/2 lg:w-full' src="room-1.jpg" alt="" />
                            <img className='rounded-xl w-1/2 lg:w-full' src="room-2.jpg" alt="" />
                        </div>
                    </div>
                    <div>
                        <span className='text-xl lg:text-3xl my-5 block text-center'>О нас</span>
                        <h2 className='text-2xl md:text-4xl font-bold text-3 mt-2 mb-14 text-center'>Найбільший готельний комплекс із щирим вибором додаткових послуг</h2>
