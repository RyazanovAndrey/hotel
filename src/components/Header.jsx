        ...
        <header className='fixed w-full top-7 left-0 z-90 px-5'>
            <div className="relative container mx-auto px-5 py-3 flex items-center justify-between bg-white rounded-xl shadow-2xl">
                ...
                <ul className='hidden lg:flex gap-x-15 text-lg'>
                    <li><NavLink to={'/'} className={activeLink}>Головна</NavLink></li>
                    <li><NavLink to={'/about'} className={activeLink}>О нас</NavLink></li>
                    <li><NavLink to={'/room'} className={activeLink}>Наші номери</NavLink></li>
                    <li><NavLink to={'/contacts'} className={activeLink}>Контакти</NavLink></li>
                </ul>
